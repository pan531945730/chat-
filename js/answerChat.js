;
$(function() {
    //极光文档地址https://docs.jiguang.cn/jmessage/client/im_sdk_js_v2/
    ...
    chat.prototype.userTep = function(v) {
            ...
            html += "<div class='user-logo'><img src='img/head/2017.jpg'/></div>";
    ...
    chat.prototype.addUserPeople = function(v) {
            var self = this;
            var html = '';
            html += '<li class="person" data-id="' + v.from_id + '">';
            html += '<div class="person-box"><img src="img/head/2017.jpg"><label class="news"></label></div>';
    ...
    chat.prototype.reply = function(v) {
            ...
            html += "<div class='user-logo'><img src='img/head/2018.jpg'/></div>";
            html += "<div class='wrap-text'>" + v.msg_body.text + "</div>";
            html += "</div>";
            return html;
        }
    ...
    var hash = hex_md5("appkey=69cacec81309bde0b1ffa029&timestamp=1483512099743&random_str=Keo2PFnUJS6v2CBBb4thxdMB4380wV83&key=c88ed719d726a7c12d5dc258");
    console.log(hash)
    var chatInit = new chat({
        appkey: '69cacec81309bde0b1ffa029',
        randomStr: 'Keo2PFnUJS6v2CBBb4thxdMB4380wV83',
        signature: hash,
        timestamp: '1483512099743',
        username: 'kf000013',
        password: '123456'
    });
});